...
import { Play, Eye, EyeOff, Loader2, AlertCircle, CheckCircle, ArrowRight, Crown, Edit, Settings } from 'lucide-react'
      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-sm text-center">Fill in your details to create your VideoFlow account</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                {formData.password && (
                  <div className="mt-2">
                    ...
                    {passwordStrength.feedback.length > 0 && (
                      <p className="text-xs text-gray-500">Missing: {passwordStrength.feedback.join(", ")}</p>
                    )}
                  </div>
                )}
              </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 rounded-xl border border-gray-200 hover:border-indigo-300 transition-colors">
                    ...
                    <Label htmlFor="creator" className="cursor-pointer flex-1">
                      <div>
                        ...
                        <div className="text-xs text-gray-500">Manage your own channel and team</div>
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-xl border border-gray-200 hover:border-indigo-300 transition-colors">
                    ...
                    <Label htmlFor="editor" className="cursor-pointer flex-1">
                      <div>
                        ...
                        <div className="text-xs text-gray-500">Upload and edit videos for creators</div>
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-xl border border-gray-200 hover:border-indigo-300 transition-colors">
                    ...
                    <Label htmlFor="manager" className="cursor-pointer flex-1">
                      <div>
                        ...
                        <div className="text-xs text-gray-500">Manage team operations and analytics</div>
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
